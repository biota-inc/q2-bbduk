...
plugin.methods.register_function(
    ...
    parameters={
        ...
        'minavgquality': Int % Range(0, None),
    ...
    parameter_descriptions={
        ...
        'minavgquality': '(mbq) Reads with any base below this quality (after trimming) will be discarded.',
        'maxns': 'If non-negative, reads with more Ns than this (after trimming) will be discarded.',
